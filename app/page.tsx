...
export default function SomiFinanceLanding() {
  return (
    <div className="relative min-h-screen text-white bg-[radial-gradient(60%_60%_at_50%_-10%,rgba(255,132,0,0.25),transparent),radial-gradient(40%_30%_at_100%_10%,rgba(14,165,233,0.18),transparent)]">
      {/* Grid overlay */}
      ...
      <header className="sticky top-0 z-40 border-b border-white/10 backdrop-blur supports-[backdrop-filter]:bg-white/5">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4">
          <Link href="/" className="group inline-flex items-center gap-2">
            <span className="h-7 w-7 rounded-xl bg-gradient-to-br from-orange-500 to-amber-700 shadow-md shadow-orange-500/30" />
            <span className="bg-gradient-to-r from-orange-400 via-amber-300 to-yellow-200 bg-clip-text text-lg font-bold tracking-tight text-transparent group-hover:opacity-90">Somi Finance</span>
          </Link>
          ...
          <div className="flex items-center gap-3">
            <Link href="/app" className="rounded-2xl bg-orange-500 px-4 py-2 text-sm font-semibold text-white shadow hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-300">App</Link>
          </div>
        </div>
      </header>
        ...
        <div className="grid items-center gap-10 md:grid-cols-2">
          <div className="space-y-6">
            ...
            <h1 className="text-balance text-4xl font-extrabold tracking-tight md:text-6xl">
              Save. Earn. <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 via-amber-300 to-yellow-200">Stay Liquid.</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="/app" className="inline-flex items-center gap-2 rounded-2xl bg-orange-500 px-5 py-3 text-sm font-semibold text-white hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-300">
                Launch App <Icon.ArrowRight className="h-4 w-4" />
              </Link>
              <a href="#features" className="rounded-2xl border border-white/20 bg-white/5 px-5 py-3 text-sm font-semibold text-white hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-white/20">Explore Features</a>
            </div>
          ...
          <div className="relative">
            ...
            <div className="pointer-events-none absolute -inset-10 -z-10 blur-3xl [background:radial-gradient(100px_80px_at_70%_20%,rgba(255,150,60,0.35),transparent),radial-gradient(160px_140px_at_20%_60%,rgba(99,102,241,0.25),transparent)]"/>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="mx-auto max-w-7xl px-4 py-20">
        <div className="mb-10 flex items-end justify-between">
          ...
          <a href="/docs" className="text-sm text-orange-300 hover:text-orange-200">Read the docs →</a>
        </div>
        <div className="grid gap-6 md:grid-cols-3">
          {[{icon:<Icon.Chart className="h-5 w-5"/>,t:"Real-time yield",d:"Transparent accounting and share-based accruals."},
            ...
            .map((f, i) => (
              <div key={i} className="h-full rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur transition hover:bg-white/10">
                <div className="mb-3 inline-flex h-9 w-9 items-center justify-center rounded-xl bg-white/10">{f.icon}</div>
      ...
      <section id="how" className="mx-auto max-w-7xl px-4 pb-20">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {[
            ...
            <div key={x.s} className="relative rounded-2xl border border-white/10 bg-white/5 p-6">
              <div className="mb-2 inline-flex h-7 w-7 items-center justify-center rounded-full bg-orange-500 text-sm font-bold">{x.s}</div>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-24">
        <div className="overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-white/5 via-white/10 to-white/5 p-8 text-center shadow-lg">
          ...
          <div className="mt-6 flex justify-center gap-3">
            ...
            <a href="/docs" className="rounded-2xl border border-white/20 bg-white/5 px-5 py-3 text-sm font-semibold text-white hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-white/20">Read Docs</a>
          </div>
        </div>
      </section>
